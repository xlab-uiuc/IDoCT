...
CTEST_NETTY_TRANSPORT_DIR = os.path.join(APP_DIR, "netty")
...
MODULE_PATH = {
    ...
    "netty-transport": CTEST_NETTY_TRANSPORT_DIR
}
...
MVN_TEST_PATH = {
    ...
    "netty-transport": os.path.join(CTEST_NETTY_TRANSPORT_DIR, SRC_SUBDIR["netty-transport"])
}
...
CTEST_SUREFIRE_PATH = {
    ...
    "netty-transport": [
        os.path.join(CTEST_NETTY_TRANSPORT_DIR, SRC_SUBDIR["netty-transport"], SUREFIRE_SUBDIR)
    ]
}
